  ...
  build: {
    rollupOptions: {
      input: {
        ...
        lavaCellMembrane: resolve(__dirname, "lava-cell-membrane.html"),
        prismBiofoam: resolve(__dirname, "prism-biofoam.html"),
        darkGlassLattice: resolve(__dirname, "dark-glass-lattice.html"),
        neonVeinNetwork: resolve(__dirname, "neon-vein-network.html"),
        ...
        neonRibbonPattern: resolve(__dirname, "neon-ribbon-pattern.html"),
        ...
        audioReactiveBlackBlob: resolve(
          __dirname,
          "audio-reactive-black-blob.html",
        ),
        audioReactiveDotOrb: resolve(__dirname, "audio-reactive-dot-orb.html"),
        ...
        spaceEarth: resolve(__dirname, "space-earth.html"),
        ...
        tuxPenguin: resolve(__dirname, "tux-penguin.html"),
        ...
        meshyPost1Avatar: resolve(__dirname, "meshy-post1-avatar.html"),
        ...
        aiCharacterFinal: resolve(__dirname, "ai-character-final.html"),
        digitalRain: resolve(__dirname, "digital-rain.html"),
        eclipseGlow: resolve(__dirname, "eclipse-glow.html"),
        hologramGlitch: resolve(__dirname, "hologram-glitch.html"),
        inkDissolve: resolve(__dirname, "ink-dissolve.html"),
        inkDissolveToxic: resolve(__dirname, "ink-dissolve-toxic.html"),
        inkDissolveRazer: resolve(__dirname, "ink-dissolve-razer.html"),
        inkDissolveBlackToxic: resolve(
          __dirname,
          "ink-dissolve-black-toxic.html",
        ),
        inkDissolveBlackRazer: resolve(
          __dirname,
          "ink-dissolve-black-razer.html",
        ),
        inkDissolveRedBlack: resolve(__dirname, "ink-dissolve-red-black.html"),
        inkDissolveBlueBlack: resolve(
          __dirname,
          "ink-dissolve-blue-black.html",
        ),
        inkDissolveIndigo: resolve(__dirname, "ink-dissolve-indigo.html"),
        magmaCore: resolve(__dirname, "magma-core.html"),
        metamorphosis: resolve(__dirname, "metamorphosis.html"),
        neonDrip: resolve(__dirname, "neon-drip.html"),
        rainUmbrella: resolve(__dirname, "rain-umbrella.html"),
        sequinWave: resolve(__dirname, "sequin-wave.html"),
        shiftingVeils: resolve(__dirname, "shifting-veils.html"),
        smolder: resolve(__dirname, "smolder.html"),
        synthRibbon: resolve(__dirname, "synth-ribbon.html"),
        velvetSpotlight: resolve(__dirname, "velvet-spotlight.html"),
        aetherDrift: resolve(__dirname, "aether-drift.html"),
        razerAetherDrift: resolve(__dirname, "razer-aether-drift.html"),
        razerAudioCamBorder: resolve(__dirname, "razer-audio-cam-border.html"),
        razerCamBorderRect: resolve(__dirname, "razer-cam-border-rect.html"),
        razerCamBorderRhombic: resolve(
          __dirname,
        ...
        razerStatusLine: resolve(__dirname, "razer-status-line.html"),
        razerLogoMark: resolve(__dirname, "razer-logo-mark.html"),
        razerBgCoding: resolve(__dirname, "razer-bg-coding.html"),
        razerBgGaming: resolve(__dirname, "razer-bg-gaming.html"),
        razerBgTalking: resolve(__dirname, "razer-bg-talking.html"),
        razerCornerAccents: resolve(__dirname, "razer-corner-accents.html"),
        glitchVeil: resolve(__dirname, "glitch-veil.html"),
        sunkenLight: resolve(__dirname, "sunken-light.html"),
        diagonalStreaks: resolve(__dirname, "diagonal-streaks.html"),
        razerDiagonalStreaks: resolve(__dirname, "razer-diagonal-streaks.html"),
        cyanDiagonalStreaks: resolve(__dirname, "cyan-diagonal-streaks.html"),
        magentaDiagonalStreaks: resolve(
          __dirname,
          "magenta-diagonal-streaks.html",
        ),
        amberDiagonalStreaks: resolve(__dirname, "amber-diagonal-streaks.html"),
        ultravioletDiagonalStreaks: resolve(
          __dirname,
          "ultraviolet-diagonal-streaks.html",
        ),
        whiteoutDiagonalStreaks: resolve(
          __dirname,
          "whiteout-diagonal-streaks.html",
        ),
        fluidBlobFrame: resolve(__dirname, "fluid-blob-frame.html"),
        colorWaveRibbons: resolve(__dirname, "color-wave-ribbons.html"),
        halftoneGradient: resolve(__dirname, "halftone-gradient.html"),
        liquidPaperFrame: resolve(__dirname, "liquid-paper-frame.html"),
        psychedelicMarble: resolve(__dirname, "psychedelic-marble.html"),
        darkNeonMarble: resolve(__dirname, "dark-neon-marble.html"),
        razerToxicMarble: resolve(__dirname, "razer-toxic-marble.html"),
        blueLiquidMarble: resolve(__dirname, "blue-liquid-marble.html"),
        tealRedMarble: resolve(__dirname, "teal-red-marble.html"),
        amethystMarble: resolve(__dirname, "amethyst-marble.html"),
        emberForgeMarble: resolve(__dirname, "ember-forge-marble.html"),
        arcticFrostMarble: resolve(__dirname, "arctic-frost-marble.html"),
        bioluminescentMarble: resolve(__dirname, "bioluminescent-marble.html"),
        goldenDotField: resolve(__dirname, "golden-dot-field.html"),
        triangleSparkle: resolve(__dirname, "triangle-sparkle.html"),
        blueDiamondHalftone: resolve(__dirname, "blue-diamond-halftone.html"),
        glitchApe: resolve(__dirname, "glitch-ape.html"),
        pixelSkull: resolve(__dirname, "pixel-skull.html"),
        waterGoldfish: resolve(__dirname, "water-goldfish.html"),
        waterSplashRingCam: resolve(__dirname, "water-splash-ring-cam.html"),
        paintVortex: resolve(__dirname, "paint-vortex.html"),
        warpTunnelRush: resolve(__dirname, "warp-tunnel-rush.html"),
        rainbowLightningRingCam: resolve(
          __dirname,
        ...
        amberTerminal: resolve(__dirname, "amber-terminal.html"),
        toxicDevTerminal: resolve(__dirname, "toxic-dev-terminal.html"),
        cyanDataStream: resolve(__dirname, "cyan-data-stream.html"),
        toxicDevDataStream: resolve(__dirname, "toxic-dev-data-stream.html"),
        toxicDevCorrupt: resolve(__dirname, "toxic-dev-corrupt.html"),
        redCorrupt: resolve(__dirname, "red-corrupt.html"),
        halftoneFade: resolve(__dirname, "halftone-fade.html"),
        razerHalftoneFade: resolve(__dirname, "razer-halftone-fade.html"),
        goldMarbleDots: resolve(__dirname, "gold-marble-dots.html"),
        toxicMarbleDots: resolve(__dirname, "toxic-marble-dots.html"),
        blueMosaicFlow: resolve(__dirname, "blue-mosaic-flow.html"),
        magentaDotFlow: resolve(__dirname, "magenta-dot-flow.html"),
        neonTopo: resolve(__dirname, "neon-topo.html"),
      },
    },
  },
  define: {
